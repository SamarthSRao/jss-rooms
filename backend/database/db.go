...
func InitDB() {
	...
	if err := db.AutoMigrate(&models.User{}, &models.Room{}, &models.Message{}, &models.Event{}, &models.Registration{}, &models.Activity{}, &models.ActivityRegistration{}, &models.Team{}); err != nil {
