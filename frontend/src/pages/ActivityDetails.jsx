...
import { MapPin, Calendar, Users, ArrowLeft, Shield, Ticket, Zap } from 'lucide-react';
                        ...
                        <div className="responsive-main-col" style={{ gridColumn: 'span 2' }}>
                            <div style={{
                                ...
                                <div className="responsive-hero-section" style={{
                                    ...
                                    {activity.image_url ? (
                                        <img src={activity.image_url} alt={activity.title} style={{ width: '100%', height: '100%', objectCover: 'cover', opacity: 0.5, position: 'absolute' }} />
                                    ) : (
                                        <>
                                            <div style={{
                                                position: 'absolute',
                                    ...
                                    <div className="responsive-meta-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '48px', marginBottom: '64px' }}>
                                        ...
                                        <div>
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                                                ...
                                                <div>
                                                    <div style={{ fontSize: '20px', fontWeight: '900', textTransform: 'uppercase' }}>{activity.location || 'TBA'}</div>
                                                    <div style={{ fontSize: '12px', opacity: 0.6, fontFamily: 'monospace' }}>CAMPUS LOCATION</div>
                                                </div>
                                            </div>
                                        </div>
                                        {/* Contact info removed if not present in activity struct, or can be inherited from event if needed */}
                                    </div>

                                    <div>
                                        <div style={{ fontSize: '9px', opacity: 0.4, letterSpacing: '0.2em', marginBottom: '24px', textTransform: 'uppercase', fontFamily: 'monospace' }}>ABOUT ACTIVITY</div>
                                        <p style={{
                                            opacity: 0.8,
                                            lineHeight: 1.8,
                                            fontSize: '18px',
                                            ...
                                            <div style={{ marginBottom: '64px', textAlign: 'left' }}>
                                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '16px' }}>
                                                    <div>
                                                        ...
                                                        <div style={{ fontWeight: '700', textTransform: 'uppercase', color: '#22c55e' }}>OPEN</div>
                                                    </div>
